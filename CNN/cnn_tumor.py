...
image_dir="MODELS/CNN/tumordataset/tumordata"
...
history=cnn_model.fit(x_train,y_train,epochs=5,batch_size =128,validation_split=0.1)
...
plt.savefig("C:/Users/jeena/Desktop/Deep learning/DL-ALGORITHMS-main (1)/DL-ALGORITHMS-main/CNN/tumor_detection/images/tumor_sample_accuracy_plot.png")
...
plt.savefig('C:/Users/jeena/Desktop/Deep learning/DL-ALGORITHMS-main (1)/DL-ALGORITHMS-main/CNN/tumor_detection/images/tumor_sample_loss_plot.png')
...
make_prediction(r'C:\Users\jeena\Desktop\Deep learning\Streamlit App\MODELS\CNN\tumordataset\tumordata\yes\y6.jpg',cnn_model)
print("--------------------------------------\n")
make_prediction(r'C:\Users\jeena\Desktop\Deep learning\Streamlit App\MODELS\CNN\tumordataset\tumordata\no\no1.jpg',cnn_model)
print("--------------------------------------\n")
